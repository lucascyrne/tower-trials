-- Evita erro 42P10 em ambientes sem constraint única compatível no activity log.
-- O erro aparecia como 400 em secure_grant_xp / secure_grant_gold.
...
BEGIN
    ...
    UPDATE characters
    SET gold = gold + p_gold_amount, last_activity = NOW()
    WHERE id = p_character_id
