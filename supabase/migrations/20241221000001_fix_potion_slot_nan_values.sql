-- Corrigir função consume_potion_from_slot para evitar valores NaN
-- Migração: 20241221000001_fix_potion_slot_nan_values.sql

-- Dropar a função existente
DROP FUNCTION IF EXISTS consume_potion_from_slot(UUID, INTEGER);

-- Recriar a função com validação robusta contra NaN
