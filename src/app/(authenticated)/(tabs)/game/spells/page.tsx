...
import { SpellService, AvailableSpell, SpellStats } from '@/resources/game/spell.service';
import { CharacterService } from '@/resources/game/character.service';
import { Character } from '@/resources/game/models/character.model';
import { SpellEffectType } from '@/resources/game/models/spell.model';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/game/play')} className="mt-4">
            Voltar
          </Button>
        </div>
      </div>
