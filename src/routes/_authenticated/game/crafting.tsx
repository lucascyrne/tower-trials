...
import type { CharacterConsumable, CraftingRecipe, MonsterDrop } from '@/resources/game/models/consumable.model'
import type { CharacterEquipment, Equipment, EquipmentCraftingRecipe } from '@/resources/game/models/equipment.model'
...
function CraftingPage() {
  ...
  useEffect(() => {
    ...
    if (characterId && characters.length > 0) {
      ...
      navigate({ to: '/game/crafting', search: { character: characters[0].id } })
    }
  }, [mounted, characters, selectedCharacter, characterId])
      ...
      <div className="mb-6">
        <div className="flex flex-col gap-4">
          <Button
            variant="outline"
            size="sm"
            onClick={() => navigate({ to: '/game/play/hub', search: { character: selectedCharacter.id } })}
...
export const Route = createFileRoute('/_authenticated/game/crafting')({
