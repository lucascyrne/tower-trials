      ...
      <Section>
        <Container className="grid gap-12 md:grid-cols-[1.5fr_0.5fr_0.5fr]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link href="/privacidade" className="text-muted-foreground hover:text-primary transition-colors">Privacidade</Link>
            <Link href="/termos" className="text-muted-foreground hover:text-primary transition-colors">Termos</Link>
          </div>
        </Container>
