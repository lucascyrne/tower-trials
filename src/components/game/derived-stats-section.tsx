...
import { CharacterStats } from '@/resources/game/models/character.model';
...
export function DerivedStatsSection({ characterStats }: DerivedStatsSectionProps) {
  ...
  const calculatedTotalMana = manaFromBase + manaFromIntelligence + manaFromWisdom + manaFromMagicMastery;
  ...
  const calculatedTotalAtk = atkFromBase + atkFromStrength + atkFromWeaponMastery + atkFromDexterity;
  ...
  const calculatedTotalMagicAtk = magicAtkFromBase + magicAtkFromIntelligence + magicAtkFromWisdom + magicAtkFromMagicMastery;
  ...
  const calculatedCritChance = Math.min(75.0, critChanceFromDexterity + critChanceFromLuck + critChanceFromStrength);
  ...
  const calculatedCritDamage = Math.min(250.0, critDamageBase + critDamageFromStrength + critDamageFromLuck + critDamageFromWeaponMastery);
  ...
  let rawMagicDamage = magicDamageFromIntelligence + magicDamageFromWisdom + magicDamageFromMagicMastery;
  // Diminishing returns
  ...
  const statsConfig = [
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Vitalidade^1.3 × 2.5:`, value: `+${hpFromVitality} (${vit}^1.3)`, color: 'text-pink-400' },
          { label: `Força^1.2 × 0.3:`, value: `+${hpFromStrength} (${str}^1.2)`, color: 'text-red-400' },
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Inteligência^1.25 × 1.5:`, value: `+${manaFromIntelligence} (${int}^1.25)`, color: 'text-purple-400' },
          { label: `Sabedoria^1.1 × 1.0:`, value: `+${manaFromWisdom} (${wis}^1.1)`, color: 'text-blue-300' },
          { label: `Maestria Mágica^1.15 × 0.8:`, value: `+${manaFromMagicMastery} (${magicMastery}^1.15)`, color: 'text-cyan-400' },
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Força^1.2 × 1.2:`, value: `+${atkFromStrength} (${str}^1.2)`, color: 'text-red-400' },
          { label: `Maior Maestria^1.1 × 0.6:`, value: `+${atkFromWeaponMastery} (${Math.max(swordMastery, axeMastery, bluntMastery)}^1.1)`, color: 'text-orange-400' },
          { label: `Destreza^1.15 × 0.2:`, value: `+${atkFromDexterity} (${dex}^1.15)`, color: 'text-green-400' },
    ...
    ...(characterStats.magic_attack && characterStats.magic_attack > 0 ? [{
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Inteligência^1.25 × 1.4:`, value: `+${magicAtkFromIntelligence} (${int}^1.25)`, color: 'text-purple-400' },
          { label: `Sabedoria^1.1 × 0.8:`, value: `+${magicAtkFromWisdom} (${wis}^1.1)`, color: 'text-blue-300' },
          { label: `Maestria Mágica^1.15 × 1.0:`, value: `+${magicAtkFromMagicMastery} (${magicMastery}^1.15)`, color: 'text-cyan-400' },
          { label: `Subtotal Calculado:`, value: calculatedTotalMagicAtk, color: 'text-gray-300' }
        ],
        0,
    ...
    }] : []),
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Vitalidade^1.3 × 0.6:`, value: `+${defFromVitality} (${vit}^1.3)`, color: 'text-pink-400' },
          { label: `Sabedoria^1.1 × 0.5:`, value: `+${defFromWisdom} (${wis}^1.1)`, color: 'text-blue-300' },
          { label: `Maestria Defesa^1.2 × 1.0:`, value: `+${defFromDefenseMastery} (${defenseMastery}^1.2)`, color: 'text-cyan-400' },
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Destreza^1.15 × 1.0:`, value: `+${speedFromDexterity} (${dex}^1.15)`, color: 'text-green-400' },
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          { label: `Destreza^1.15 × 0.25:`, value: `${critChanceFromDexterity.toFixed(1)}% (${dex}^1.15)`, color: 'text-green-400' },
          { label: `Sorte × 0.35:`, value: `+${critChanceFromLuck.toFixed(1)}% (${luck})`, color: 'text-yellow-300' },
          { label: `Força^1.2 × 0.1:`, value: `+${critChanceFromStrength.toFixed(1)}% (${str}^1.2)`, color: 'text-red-400' },
          { label: `Cap Máximo: 75%`, value: '', color: 'text-orange-400' },
          { label: `Valor Calculado:`, value: `${calculatedCritChance.toFixed(1)}%`, color: 'text-gray-300' }
        ],
        0,
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          ...
          { label: `Força^1.2 × 0.4:`, value: `+${critDamageFromStrength.toFixed(1)}% (${str}^1.2)`, color: 'text-red-400' },
          { label: `Sorte × 0.6:`, value: `+${critDamageFromLuck.toFixed(1)}% (${luck})`, color: 'text-yellow-300' },
          { label: `Maior Maestria^1.1 × 0.3:`, value: `+${critDamageFromWeaponMastery.toFixed(1)}% (${Math.max(swordMastery, axeMastery, bluntMastery)}^1.1)`, color: 'text-orange-400' },
          { label: `Cap Máximo: 250%`, value: '', color: 'text-orange-400' },
          { label: `Valor Calculado:`, value: `${calculatedCritDamage.toFixed(0)}%`, color: 'text-gray-300' }
        ],
        0,
    ...
    },
    {
      ...
      tooltipData: createExactTooltipData(
        ...
        [
          { label: `Inteligência^1.25 × 1.2:`, value: `${magicDamageFromIntelligence.toFixed(1)}% (${int}^1.25)`, color: 'text-purple-400' },
          { label: `Sabedoria^1.1 × 0.8:`, value: `+${magicDamageFromWisdom.toFixed(1)}% (${wis}^1.1)`, color: 'text-blue-300' },
          { label: `Maestria Mágica^1.15 × 1.5:`, value: `+${magicDamageFromMagicMastery.toFixed(1)}% (${magicMastery}^1.15)`, color: 'text-cyan-400' },
          { label: `Diminishing Returns após 100%`, value: '', color: 'text-orange-400' },
          { label: `Cap Máximo: 200%`, value: '', color: 'text-orange-400' },
          { label: `Valor Calculado:`, value: `${calculatedMagicDamage.toFixed(1)}%`, color: 'text-gray-300' }
        ],
        0,
