import { type Equipment, type CharacterEquipment, type EquipmentSlots, type EquipmentCraftingRecipe, type EquipmentType, type WeaponSubtype, type EquipmentRarity, type EquipmentComparison } from './models/equipment.model';
