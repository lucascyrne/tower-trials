    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <DialogHeader className={`${isMobileLandscape ? 'pb-2' : ''}`}>
          ...
          <DialogDescription className={`${isMobileLandscape ? 'text-xs' : 'text-base'}`}>
        ...
        >
          ...
          <div
            className={`bg-red-500/10 border border-red-500/20 rounded-lg space-y-2 ${
              isMobileLandscape ? 'p-2' : 'p-4'
            }`}
          >
            <p className={`font-medium ${isMobileLandscape ? 'text-xs' : 'text-sm'}`}>
            ...
            <div
              className={`${isMobileLandscape ? 'grid grid-cols-2 gap-1 text-xs' : 'space-y-1'}`}
            >
              <div
          ...
          <div className={`bg-muted rounded-lg ${isMobileLandscape ? 'p-2' : 'p-4'}`}>
            <p className={`font-medium mb-2 ${isMobileLandscape ? 'text-xs' : 'text-sm'}`}>
              💡 Dicas de Sobrevivência:
            </p>
        ...
        {/* Botões responsivos */}
        <div className={`flex gap-2 ${isMobileLandscape ? 'pt-2' : 'pt-4'}`}>
          <Button
            variant="outline"
            onClick={onClose}
          ...
          <Button
            ...
            className={`flex-1 ${isMobileLandscape ? 'text-xs h-8' : ''}`}
          >
            <Skull className={`mr-1 ${isMobileLandscape ? 'h-3 w-3' : 'h-4 w-4 mr-2'}`} />
